...
\end{figure}
   ...
   \large{Department of Mechatronic Engineering}\\
    ...
    ------------------------------------------------------------------------------------------------\\[1.0cm]
    \textbf{Unit Title}: CAD/CAM\\[0.6cm]
    \textbf{Unit Code} : EMT 2538\\[0.6cm]
    \textbf{Project 2: Manual and Computer-Aided Part Programming
            }\\[0.6cm]
    %\large{by}\\[0.6cm
    ...
    %\large{\textbf{Sammy Kerata Oina (ENM221-0089/2017)
           % }}\\
     \large{\textbf{Cheruiyot Bernie Kiplelgo~(ENM221-0074/2017)
                 }}\\[0.8cm]
     \large{\textbf{Earl Spencer Mogire~(ENM221-0074/2017)
            }}\\[0.8cm]
     \large{\textbf{Munywoki Faith Ndinda~(ENM221-0077/2017)
                 }}\\[0.8cm] 
     \large{\textbf{Oina Kerata Sammy~(ENM221-0089/2017)
                 }}\\[0.8cm]      
